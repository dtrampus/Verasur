 ...
 */
class IngressRepository extends EntityRepository {

    public function ajaxTable(array $get, $flag = false) {
        /* DB table to use */
        $tableObjectName = 'MainBundle:Ingress';
        /**
         * Set to default
         */
        $arrayColumns = array();
        ...
        $cb = $this->getEntityManager()
                ...
                ->select($arrayColumns)
                ->from('MainBundle\Entity\Ingress', 'i')
                ->innerJoin('i.provider', 'provider')
                ->innerJoin('i.product', 'product')
                ->innerJoin('i.transport', 'transport');
    ...
    public function getCount() {
        $aResultTotal = $this->getEntityManager()
                ->createQuery('SELECT COUNT(a) FROM MainBundle:Ingress a')
                ->setMaxResults(1)
                ->getResult();
